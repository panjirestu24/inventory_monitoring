-- ============================================================
-- DATABASE LENGKAP: db_inventory
-- Sistem Inventory & Monitoring Percetakan
-- ============================================================
-- FILE INI SUDAH MENGGABUNGKAN:
--   ✅ db_inventory.sql        (tabel utama + data awal)
--   ✅ migrate_deliveries.sql  (tabel deliveries)
--   ✅ migrate_products.sql    (tabel products)
--   ✅ migrate_proof_image.sql (kolom proof_image)
-- ============================================================
-- CARA IMPORT:
--   1. Buka phpMyAdmin
...
-- ============================================================
-- TABLE: products (Daftar Produk/Jasa Percetakan)
-- ============================================================
...
-- ============================================================
-- TABLE: order_items (Detail Bahan per Order)
-- ============================================================
...
-- Digabung dari: migrate_deliveries.sql + migrate_proof_image.sql
-- ============================================================
...
-- ============================================================
-- TABLE: machine_logs (Log Aktivitas Mesin)
-- ============================================================
...
-- Products (Daftar Jasa/Produk Percetakan)
...
--   6.  machines         - Mesin percetakan
--   7.  items            - Bahan baku / inventory
--   8.  products         - Daftar produk/jasa percetakan
--   9.  orders           - Order / pesanan cetak
--   10. order_items      - Detail bahan per order
--   11. deliveries       - Data pengiriman (+ kolom proof_image)
--   12. stock_transactions - Mutasi stok masuk/keluar
--   13. purchases        - Purchase Order ke supplier
--   14. purchase_items   - Detail item per PO
--   15. machine_logs     - Log aktivitas mesin
